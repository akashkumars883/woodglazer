          ...
          <FadeIn>
            ...
            <div className="prose prose-stone max-w-none space-y-8 text-stone-600 font-medium leading-relaxed">
              <section>
                ...
                <p>
                  At Wood Glazer, we respect your privacy and are committed to protecting your personal data. This privacy policy will inform you about how we look after your personal data when you visit our website (woodglazer.com) and tell you about your privacy rights and how the law protects you.
                </p>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li><strong>Contact Data:</strong> Includes email address, phone number, and location details.</li>
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>To improve our website performance, services, and overall user experience.</li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p>
                  If you have any questions about this privacy policy or our privacy practices, please contact us at: <strong>woodglazer@gmail.com</strong> or call us at <strong>+91 9717048359</strong>.
                </p>
              </section>
            </div>
          </FadeIn>
