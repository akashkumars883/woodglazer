...
export default function CTASection() {
  ...
  return (
    <section className="relative overflow-hidden bg-black py-16 sm:py-16">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col items-center text-center">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 tracking-tight max-w-3xl leading-[1.1]">
            Ready to{" "}
            <span className="text-white/80 italic font-serif">Transform</span>{" "}
